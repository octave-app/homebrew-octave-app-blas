# "default" (head of development/unstable branch) version of Octave, built against
...
class OctaveDefaultOpenblas < Formula
  ...
  def post_install
    system "ln", "-sf", "#{bin}/octave", "#{HOMEBREW_PREFIX}/bin/octave-default-openblas"
  end
