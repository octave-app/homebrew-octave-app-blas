...
class OctaveStableOpenblas < Formula
  ...
  keg_only "so it can be installed alongside other octaves"
  ...
  def post_install
    system "ln", "-sf", "#{bin}/octave", "#{HOMEBREW_PREFIX}/bin/octave-stable-openblas"
  end
